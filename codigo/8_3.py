...
# Ejercicio 3: Pulso Cuadrado Simetrico
...
# =============================================================================
# 9. MATEMATICA FOURIER — EJERCICIO 3: PULSO CUADRADO SIMETRICO
#    Periodo T = 1  =>  w0 = 2*pi
#    a0 = 1
#    an = (2 / (n*pi)) * sin(n*pi/2)
#    bn = 0   (funcion par: solo cosenos)
#    Rango: [0, 1] con sobrepico de Gibbs ~1.09
#    Clamp DAC: [0.0, 1.0]  => valor_dac = int(fx_clamp * 255)
# =============================================================================
...
def coef_an(n):
    return (2.0 / (n * math.pi)) * math.sin(n * math.pi / 2)
...
def core0_generador_loop(nmax, lista_an, lista_bn):
    ...
    while True:
        ...
        # Clamp y mapeo DAC — Pulso Cuadrado: rango [0, 1]
        fx_clamp  = max(0.0, min(1.0, fx))
        valor_dac = int(fx_clamp * 255)
        GPIO_SALP(valor_dac)
...
def ejecutar_generador():
    ...
    print("\n" + "=" * 42)
    print("  GENERADOR — EJ3 PULSO CUADRADO SIMETRICO")
    print("  T=1  w0=2pi  a0=1  bn=0")
    print("=" * 42)
...
def main():
    print("=" * 50)
    print("  LAB 8 — EJ3 PULSO CUADRADO SIMETRICO")
    print("  GP14 btn_set  : avanza modo (1->2->3->4->5->1)")
    print("  GP15 btn_reset: vuelve a Modo 1")
    print("=" * 50)

    oled.fill(0)
    oled.text("LAB 8 - EJ3", 16, 4, 1)
    oled.text("PULSO CUAD.", 16, 16, 1)
